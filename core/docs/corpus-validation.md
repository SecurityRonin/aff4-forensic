...
## Bevy index format (foundational correction)
...
data, every symbolic fill, and the UnknownData seam together.
...
recomputes to that MD5. Env-gated via `AFF4L_DREAM` (see `tests/data/README.md`).
